...
void GINS_INS::Lever()
{
	...
	Mat_add(vn, temp31, vnL, 3, 1);
	Mat_mul(CW, lever2, 3, 3, 1, temp31);
	Mat_add(vnL, temp31, vnL2, 3, 1);
	...
	Mat_add(pos, temp31, posL, 3, 1);
	Mat_mul(MpvCnb, lever2, 3, 3, 1, temp31);
	Mat_add(posL, temp31, posL2, 3, 1);
